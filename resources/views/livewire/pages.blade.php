<div class='p-6'>
    ...
    <div class="flex flex-col mt-5">
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-my-8 ">
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            <div class="mt-4">
                ...
                <x-jet-input id="title" class="block mt-1 w-full" type="text" wire:model.debounce.80ms="title"/>
            ...
            <div class="mt-4">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                    ...
                    <input wire:model="slug" type="text" class="form-input flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="url-slug">
                </div>
    ...
    <x-jet-dialog-modal wire:model="modalConfirmDeleteVisible">
        ...
        <x-slot name="content">
            {{ __('Are you sure you want to delete your page? Once your account is deleted, all of its resources and data will be permanently deleted.') }}
        </x-slot>
